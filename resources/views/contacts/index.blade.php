                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <tbody>
                                ...
                                @foreach ($contacts as $contact)
                                    <tr>
                                        <td class="border-t-2 px-4 py-3 border-gray-200">{{ $contact->id }}</td>
                                        <td class="border-t-2 px-4 py-3 border-gray-200">{{ $contact->name }}</td>
                                        <td class="border-t-2 px-4 py-3 border-gray-200">{{ $contact->title }}</td>
                                        <td class="border-t-2 px-4 py-3 border-gray-200">{{ $contact->created_at }}
                                        </td>
                                        <td class="border-t-2 px-4 py-3 border-gray-200">
